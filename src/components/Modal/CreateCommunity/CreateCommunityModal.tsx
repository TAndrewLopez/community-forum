...
const CreateCommunityModal: React.FC<CreateCommunityModalProps> = ({
  ...
  const handleCreateCommunity = async () => {
    ...
    if (format.test(communityName) || communityName.length < 3) {
      setError(
        "Community names must be between 3-21 characters, and can only container letters, numbers or underscores."
      );
      return;
    }
    setLoading(true);
    try {
      ...
      console.log("An error has occurred while creating this community", error);
